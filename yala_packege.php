    ...
    <div id="page" class="full-page">
        ...
        <main id="content" class="site-main">
            ...
            <section class="inner-banner-wrap">
                <div class="inner-baner-container" style="background-image: url(assets/packages/Lepord.jpg); background-position: top center;">
                    <div class="container">
                        <div class="inner-banner-content">
                            <h1 class="inner-title">Yala Safari</h1>
                        </div>
                    </div>
                </div>
